            ...
            child: Column(
              children: [
                ...
                if (_registrationSuccess)
                  // In the registration success display section
                  Padding(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildDetailRow(
                              'Name:',
                              '${_registeredUser?.firstName} ${_registeredUser?.lastName}',
                            ),
                            _buildDetailRow(
                              'Username:',
                              _registeredUser?.username,
                            ),
                            _buildDetailRow('Email:', _registeredUser?.email),
                            _buildDetailRow('Phone:', _registeredUser?.phoneNo),
                            _buildDetailRow(
                              'Account Type:',
                              _registeredUser?.userType,
                            ),
                            const SizedBox(height: TSizes.spaceBtwItems),
                            Center(
                              child: Column(
